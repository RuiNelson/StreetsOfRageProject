...
| `walk_verbs.py` | `WalkToNearEnemy`, `RetreatFromDanger`, `ProjectileSidestep`, `EngageAntonio`, `EngageSouther`, `EngageBongo`, `EngageAbadede`, `EngageJack`, `EngageTwins`, `WalkToAdvanceStage`, `WalkToWeapon`, `WalkToPickup` |
