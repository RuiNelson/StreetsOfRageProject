...
def player_phase(
    *,
    ...
    # player and weapon, booth intact. Measured live (breakable_diag.py):
    # without this, action stuck at $47 for many consecutive ticks,
    # `OpenBreakable` re-pressing B every tick and never landing a hit. The
    # unarmed throw (held_type is the grabbed enemy) stays HOLDING so
    # knees/throws remain free.
