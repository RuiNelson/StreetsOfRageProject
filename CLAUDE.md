...
| `autoplay/` | Python remote observer / scripted SoR autoplay agent (`megadrive_remote`) | Project-owned; editable; agent behaviour is specified in `autoplay/AISpec.md` (keep in sync with `autoplay/src/sor_autoplay/agent/`) |
