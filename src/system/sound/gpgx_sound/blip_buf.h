...
/* Same as above function except sample is mixed from multiple blip buffers sources */
/* m2 is an array with 'num' blip buffer streams to be mixed with m1 blip buffer stream */
